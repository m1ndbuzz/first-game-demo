...
# Add your specific camera/look actions here
const EXCLUDED_ACTIONS = [
	"ui_accept", "ui_select", "ui_cancel", "ui_focus_next", "ui_focus_prev", 
	"ui_left", "ui_right", "ui_up", "ui_down", "ui_page_up", "ui_page_down", 
	"ui_home", "ui_end",
	"look_horizontal_positive", "look_horizontal_negative", "look_vertical_positive", "look_vertical_negative" # Add your exact Look action names here
]
